...
import enContent from './languages/category/en-US/content.json';
import enMedia from './languages/category/en-US/media.json';
...
import ptContent from './languages/category/pt-BR/content.json';
import ptMedia from './languages/category/pt-BR/media.json';
...
const categoryLabels: Record<Language, CatDict> = {
	'en-US': { ...enSubject, ...enContent, ...enMedia, ...enRegion, ...enLanguage },
	'pt-BR': { ...ptSubject, ...ptContent, ...ptMedia, ...ptRegion, ...ptLanguage }
};
