 ...
 * Takes TreeNode (role='font') instead of the old separate ContentNode entity.
 */

import type { TreeNode, FontBody, FontNostrConfig, FontRssConfig, FontAtomConfig } from '$lib/domain/content-tree/content-tree.js';
 ...
 */
export function startIngestion(node: TreeNode, onPosts: OnPostsIngested): void {
