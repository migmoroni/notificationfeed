...
removedAt: null,
activateTrees: [
{ treeId: IDS.treeProfileTech, activatedAt: now },
{ treeId: IDS.treeProfileSecurity, activatedAt: now },
{ treeId: IDS.treeProfileNews, activatedAt: now },
{ treeId: IDS.treeProfileScience, activatedAt: now },
{ treeId: IDS.treeTechBlog, activatedAt: now },
{ treeId: IDS.treeNewsDaily, activatedAt: now },
],
activateNodes: [
{ nodeId: PT.fontRss1, priority: 1, favorite: true, enabled: true, favoriteTabIds: [] },
{ nodeId: PT.root, priority: 2, favorite: false, enabled: true, favoriteTabIds: [] },
{ nodeId: PN.fontRss2, priority: null, favorite: false, enabled: true, favoriteTabIds: [] },
